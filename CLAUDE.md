...
| Layer | Document | Role |
|---|---|---|
| 1 | ASTM WKXXXXX (this standard) | Measurement method — measures ΔAUC |
| 2 | IEC 60601-2-44 Ed. 4 §203.6.7.102 | Requirement to measure and report ΔAUC |
| 3 | FDA guidance | Acceptance criteria (non-degradation threshold, superiority claim) |

See `docs_and_references/IEC_203_6_7_102_draft.md` and `docs_and_references/FDA_guidance_framework.md` for draft regulatory text.
