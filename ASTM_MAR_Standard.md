# ASTM WKXXXXX — Revision 03

**Designation:** WKXXXXX
**Work Item Number:** WKXXXXX
**Date:** 2026-03-14
**Supersedes:** Revision 02 (02/28/2026)
...
**5.5** This test method is structured to support incorporation by normative reference into external performance standards.
...
**7.2** **[Rev 03]** Computational platform capable of executing the reference 2D CHO analysis software (`run_cho_analysis_v5_3.py`).
...
**8.3** Reference CHO implementation distributed with this standard (`run_cho_analysis_v5_3.py`). The reference implementation is the normative arbiter of correct CHO output. Alternative implementations shall demonstrate numerical equivalence within ±0.001 AUC on the supplied checksum-verified validation dataset before use.
...
- (h) **[Rev 03]** Pre-observer per-voxel CNR: ~12/30 ≈ 0.4; noise-limited detection task. The 2D CHO with Vaishnav internal noise regularisation (σ_internal = 15, §A1.5.2(d)) is calibrated to AUC_noMAR = 0.7063 for this SNR.
...
| **Baseline AUC_noMAR [Rev 03]** | **0.7063 (LOO hold-out; 95% CI [0.6575, 0.7844])** | **§1A.2** |

---

*End of ASTM WKXXXXX Revision 03*

*This document was converted from Revision 02 (02/28/2026) and updated to Revision 03 (2026-03-14) to incorporate the Vaishnav Transition metrological calibration. All **[Rev 03]** markers indicate normative changes from the prior revision.*
